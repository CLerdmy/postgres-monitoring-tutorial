...
export function renderLevel3() {
    ...
    const sections = [
        ...
        quizPanel({
            ...
            explanation: "blks_read - количество блоков (страниц) прочитанных с диска. Высокое значение говорит о частом доступе к дисковому хранилищу (мало кэширования)."
        }),
