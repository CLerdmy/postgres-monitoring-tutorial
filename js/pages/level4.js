    ...
    const sections = [
        ...
        textPanel("Обзор основных расширений", [
            ...
            ul([
                ...
                "полезно для понимания эффективности кэширования данных"
            ]),
        ...
        gridPanels(
            ...
            textPanel("Метрики pg_buffercache", [
                p("Наполнение кэша (pg_buffercache):", { code: ["pg_buffercache"] }),
                ul([
                    "какие таблицы имеют сколько страниц в кэше",
                ...
                p("Показывает, какие таблицы и индексы сейчас в кэше.")
            ])
        ),

        textPanel("Анализ буферного кэша через pg_buffercache", [
        ...
        quizPanel({
            ...
            explanation: "Поле usagecount показывает, сколько раз страница попадала в кэш при алгоритме Clock. Большое значение означает частое использование, т.е. данные 'горячие'."
        }),
        ...
        quizPanel({
            ...
            explanation: "С помощью запросов к pg_buffercache можно узнать, какие таблицы и индексы имеют сколько страниц в кэше."
        }),
        ...
        quizPanel({
            ...
            options: [
                ...
                "покажет три таблицы, которые занимают больше всего страниц в буферном кэше",
                "покажет три таблицы с наибольшим количеством запросов",
                "покажет три таблицы, которые чаще всего блокируются"
            ],
            correct: "покажет три таблицы, которые занимают больше всего страниц в буферном кэше",
